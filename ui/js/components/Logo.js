    ...
    return (
      <svg version="1.1" viewBox="0 0 240 240" width="240px" height="240px"
        ...
        <g id="Bible" transform="translate(68.000000, 169.000000)" fill="#F99D27">
          <path d="M62,10.2 C62,10.2 34.5,-9.3 0.5,6 L0.5,14.8 C0.6,14.8 18.4,4.5 62,10.2 Z" className="logo__left" />
          <path d="M61.9,10.2 C61.9,10.2 89.4,-9.3 123.4,6 L123.4,14.8 C123.3,14.8 105.5,4.5 61.9,10.2 Z" className="logo__right" />
        </g>
